...
describe("AWS gamelift service testing", function()
	...
	it("should generate a cli skeleton with get_game_session_log", function()
		local result = service.get_game_session_log()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with upload_build", function()
		local result = service.upload_build()
		assert.is_true(result.success)
	end)
