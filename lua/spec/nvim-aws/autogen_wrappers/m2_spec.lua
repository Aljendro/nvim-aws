...
describe("AWS m2 service testing", function()
	...
	it("should generate a cli skeleton with create_data_set_export_task", function()
		local result = service.create_data_set_export_task()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with get_data_set_export_task", function()
		local result = service.get_data_set_export_task()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with list_data_set_export_history", function()
		local result = service.list_data_set_export_history()
		assert.is_true(result.success)
	end)
