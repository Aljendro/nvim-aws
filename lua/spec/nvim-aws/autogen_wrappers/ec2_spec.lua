...
describe("AWS ec2 service testing", function()
	...
	it("should generate a cli skeleton with create_local_gateway_virtual_interface", function()
		local result = service.create_local_gateway_virtual_interface()
		assert.is_true(result.success)
	end)
	it("should generate a cli skeleton with create_local_gateway_virtual_interface_group", function()
		local result = service.create_local_gateway_virtual_interface_group()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with delete_local_gateway_virtual_interface", function()
		local result = service.delete_local_gateway_virtual_interface()
		assert.is_true(result.success)
	end)
	it("should generate a cli skeleton with delete_local_gateway_virtual_interface_group", function()
		local result = service.delete_local_gateway_virtual_interface_group()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with describe_outpost_lags", function()
		local result = service.describe_outpost_lags()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with describe_service_link_virtual_interfaces", function()
		local result = service.describe_service_link_virtual_interfaces()
		assert.is_true(result.success)
	end)
