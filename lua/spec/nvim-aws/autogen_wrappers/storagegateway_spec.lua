...
describe("AWS storage-gateway service testing", function()
	...
	it("should generate a cli skeleton with create_cachedi_scsi_volume", function()
		local result = service.create_cachedi_scsi_volume()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with create_storedi_scsi_volume", function()
		local result = service.create_storedi_scsi_volume()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with describe_cachedi_scsi_volumes", function()
		local result = service.describe_cachedi_scsi_volumes()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with describe_storedi_scsi_volumes", function()
		local result = service.describe_storedi_scsi_volumes()
		assert.is_true(result.success)
	end)
