...
describe("AWS cloudwatch-logs service testing", function()
	...
	it("should generate a cli skeleton with list_tags_log_group", function()
		local result = service.list_tags_log_group()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with tag_log_group", function()
		local result = service.tag_log_group()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with untag_log_group", function()
		local result = service.untag_log_group()
		assert.is_true(result.success)
	end)
