...
describe("AWS emr-containers service testing", function()
	...
	it("should generate a cli skeleton with create_role_associations", function()
		local result = service.create_role_associations()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with delete_role_associations", function()
		local result = service.delete_role_associations()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with update_role_trust_policy", function()
		local result = service.update_role_trust_policy()
		assert.is_true(result.success)
	end)
end)