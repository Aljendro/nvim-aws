...
describe("AWS appconfig service testing", function()
	...
	it("should generate a cli skeleton with create_hosted_configuration_version", function()
		local result = service.create_hosted_configuration_version()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with get_hosted_configuration_version", function()
		local result = service.get_hosted_configuration_version()
		assert.is_true(result.success)
	end)
