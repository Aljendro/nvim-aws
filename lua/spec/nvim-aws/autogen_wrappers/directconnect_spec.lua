...
describe("AWS direct-connect service testing", function()
	...
	it("should generate a cli skeleton with allocate_connection_on_interconnect", function()
		local result = service.allocate_connection_on_interconnect()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with describe_connection_loa", function()
		local result = service.describe_connection_loa()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with describe_connections_on_interconnect", function()
		local result = service.describe_connections_on_interconnect()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with describe_interconnect_loa", function()
		local result = service.describe_interconnect_loa()
		assert.is_true(result.success)
	end)
