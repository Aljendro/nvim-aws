...
describe("AWS omics service testing", function()
	...
	it("should generate a cli skeleton with get_read_set", function()
		local result = service.get_read_set()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with get_reference", function()
		local result = service.get_reference()
		assert.is_true(result.success)
	end)
