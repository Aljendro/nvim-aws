...
describe("AWS iot-wireless service testing", function()
	...
	it("should generate a cli skeleton with get_position", function()
		local result = service.get_position()
		assert.is_true(result.success)
	end)

	it("should generate a cli skeleton with get_position_configuration", function()
		local result = service.get_position_configuration()
		assert.is_true(result.success)
	end)

	it("should generate a cli skeleton with get_position_estimate", function()
		local result = service.get_position_estimate()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with get_resource_position", function()
		local result = service.get_resource_position()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with list_position_configurations", function()
		local result = service.list_position_configurations()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with put_position_configuration", function()
		local result = service.put_position_configuration()
		assert.is_true(result.success)
	end)
	...
	it("should generate a cli skeleton with update_position", function()
		local result = service.update_position()
		assert.is_true(result.success)
	end)
