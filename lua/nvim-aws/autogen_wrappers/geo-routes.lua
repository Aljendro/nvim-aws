...
--- @param input table|nil The input table for the calculate_isolines command
...
--- @param input table|nil The input table for the calculate_routes command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table|nil The input table for the optimize_waypoints command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table|nil The input table for the snap_to_roads command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
