...
--- @param input table The input table for the associate_default_view command
...
--- @param input table The input table for the get_view command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_indexes command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_index_type command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_view command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
