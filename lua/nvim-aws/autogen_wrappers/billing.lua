...
--- @param input table The input table for the create_billing_view command
...
--- @param input table The input table for the delete_billing_view command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_billing_view command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_billing_views command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_source_views_for_billing_view command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_billing_view command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
