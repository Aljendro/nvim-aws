...
--- @param input table The input table for the copy_backup_to_region command
...
--- @param input table The input table for the initialize_cluster command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the modify_backup_attributes command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the restore_backup command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
