...
--- @param input table|nil The input table for the create_chat_token command
...
--- @param input table|nil The input table for the create_logging_configuration command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table|nil The input table for the disconnect_user command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
