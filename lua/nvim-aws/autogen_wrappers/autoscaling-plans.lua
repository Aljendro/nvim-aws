...
--- @param input table The input table for the create_scaling_plan command
...
--- @param input table The input table for the delete_scaling_plan command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the describe_scaling_plan_resources command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the describe_scaling_plans command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_scaling_plan_resource_forecast_data command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_scaling_plan command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
