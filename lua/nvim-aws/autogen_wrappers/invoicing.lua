...
--- @param input table The input table for the batch_get_invoice_profile command
...
--- @param input table The input table for the create_invoice_unit command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the delete_invoice_unit command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_invoice_unit command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_invoice_units command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_invoice_unit command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
