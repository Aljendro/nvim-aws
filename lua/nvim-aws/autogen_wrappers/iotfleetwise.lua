...
--- AWS iotfleetwise help operation
--- @param input table|nil Optional input parameters
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
function M.help(input)
	return common.execute_aws_command_with_input({ "iotfleetwise", "help" }, input)
end
...
function M.list_fleets_for_vehicle(input)
	return common.execute_aws_command_with_input({ "iotfleetwise", "list-fleets-for-vehicle" }, input)
end
...
function M.list_vehicles_in_fleet(input)
	return common.execute_aws_command_with_input({ "iotfleetwise", "list-vehicles-in-fleet" }, input)
end
