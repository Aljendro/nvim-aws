...
--- @param input table The input table for the apply_guardrail command
...
--- @param input table The input table for the converse command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the converse_stream command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_async_invoke command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the invoke_model command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the invoke_model_with_bidirectional_stream command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the invoke_model_with_response_stream command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_async_invokes command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the start_async_invoke command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
