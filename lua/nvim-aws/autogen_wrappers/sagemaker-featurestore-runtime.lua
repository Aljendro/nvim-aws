...
--- @param input table The input table for the batch_get_record command
...
--- @param input table The input table for the delete_record command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_record command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
