...
--- @param input table|nil The input table for the put_dial_request_batch command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table|nil The input table for the update_campaign_dialer_config command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table|nil The input table for the update_campaign_outbound_call_config command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
