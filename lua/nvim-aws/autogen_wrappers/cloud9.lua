...
--- @param input table The input table for the create_environment_ec2 command
...
--- @param input table The input table for the create_environment_membership command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the delete_environment_membership command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the describe_environment_memberships command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the describe_environment_status command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_environment_membership command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
