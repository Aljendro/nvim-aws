...
--- @param input table The input table for the delete_human_loop command
...
--- @param input table The input table for the describe_human_loop command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_human_loops command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the start_human_loop command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the stop_human_loop command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
