...
--- @param input table The input table for the create_data_automation_project command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the delete_data_automation_project command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_data_automation_project command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_data_automation_projects command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_data_automation_project command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
