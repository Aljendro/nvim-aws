...
--- @param input table|nil The input table for the list_resource_telemetry command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table|nil The input table for the list_resource_telemetry_for_organization command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
