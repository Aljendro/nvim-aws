...
--- @param input table The input table for the create_challenge command
...
--- @param input table The input table for the delete_challenge command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_challenge_metadata command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_challenge_password command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_challenge_metadata command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
