...
--- @param input table The input table for the describe_statement command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_statement_result command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the get_statement_result_v2 command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
