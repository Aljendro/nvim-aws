...
function M.batch_acknowledge_alarm(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-acknowledge-alarm" }, input)
end
...
function M.batch_delete_detector(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-delete-detector" }, input)
end
...
function M.batch_disable_alarm(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-disable-alarm" }, input)
end
...
function M.batch_enable_alarm(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-enable-alarm" }, input)
end
...
function M.batch_put_message(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-put-message" }, input)
end
...
function M.batch_reset_alarm(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-reset-alarm" }, input)
end
...
function M.batch_snooze_alarm(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-snooze-alarm" }, input)
end
...
function M.batch_update_detector(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "batch-update-detector" }, input)
end
...
function M.describe_alarm(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "describe-alarm" }, input)
end
...
function M.describe_detector(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "describe-detector" }, input)
end
...
function M.list_alarms(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "list-alarms" }, input)
end
...
function M.list_detectors(input)
	return common.execute_aws_command_skeleton({ "iotevents-data", "list-detectors" }, input)
end
