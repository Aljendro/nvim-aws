...
--- @param input table The input table for the batch_update_recommendation_resource_exclusion command
...
--- @param input table The input table for the get_organization_recommendation command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_checks command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_organization_recommendation_accounts command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_organization_recommendation_resources command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_organization_recommendations command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the list_recommendation_resources command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_organization_recommendation_lifecycle command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
...
--- @param input table The input table for the update_recommendation_lifecycle command
--- @return {success: boolean, data: table|nil, error: string|nil} Result table
